...
from swagger_server.models.get_image_response import GetImageResponse  # noqa: E501
from swagger_server.models.get_images_response import GetImagesResponse  # noqa: E501
...
class TestImageController(BaseTestCase):
    ...
    def test_get_image_by_hostcode_and_product_no(self):
        ...
        response = self.client.open(
            '//images/hosts/{hostCode}/images/{productNo}'.format(hostCode='hostCode_example', productNo='productNo_example'),
            method='GET')
    ...
    def test_get_image_by_id(self):
        ...
        """
        response = self.client.open(
            '//images/{imageId}'.format(imageId='imageId_example'),
            method='GET')
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
    ...
    def test_get_images_by_object_id(self):
        ...
        query_string = [('offset', 56),
                        ('limit', 56)]
        response = self.client.open(
            '//images/objects/{objectId}'.format(objectId='objectId_example'),
            method='GET',
            query_string=query_string)
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
    ...
    def test_get_images_by_user_image_id_and_object_index(self):
        ...
        """
        response = self.client.open(
            '//images/userImages/{userImageId}/objects/{objectIndex}'.format(userImageId='userImageId_example', objectIndex=56),
            method='GET')
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
